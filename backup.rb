...
SOURCE_LOCATION = ENV.fetch("SOURCE_LOCATION")

NEF_OUTPUT_DIR = ENV.fetch("NEF_OUTPUT_DIR")
JPG_OUTPUT_DIR = ENV.fetch("JPG_OUTPUT_DIR")

VERACRYPT_REPOSITORY_PATH = ENV.fetch("VERACRYPT_REPOSITORY_PATH")
VERACRYPT_MOUNT_PATH = ENV.fetch("VERACRYPT_MOUNT_PATH")
VERACRYPT_PHOTOS_PATH = ENV.fetch("VERACRYPT_PHOTOS_PATH")
VERACRYPT_KEYFILE_PATH = ENV.fetch("VERACRYPT_KEYFILE_PATH")

PREVIEW_DIR = ENV.fetch("PREVIEW_DIR")
IMAGE_PREVIEW_SIZE=ENV.fetch("IMAGE_PREVIEW_SIZE")
IMAGE_VIEWER=ENV.fetch("IMAGE_VIEWER")
